---
title: Introduction
description: An ergonomics layer on top of shadcn-svelte, installed into the project as source it owns.
---
...
It is a folder - installed one component at a time from
[Coral's registry](/docs/installation), or copied whole.
